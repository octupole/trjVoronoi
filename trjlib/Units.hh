...
constexpr Quantity<Joules> operator"" _Kcal(long double d) {
	return Quantity<Joules> { d*1e3*4.184 };
}
...
const auto Debye=(1.0/299792458.0)*1e-21_C * 1.0_m;
const auto Bb=1.0e-30*(1.0/2997924580.0)*1.0_C*1.0_m*1.0_m;
const auto Kcal=1.0_Kcal;
